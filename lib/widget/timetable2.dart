...
class Timetable2 extends StatelessWidget {
  ...
  static const double padding = 0.1;
  ...
  final double fixedCourseCellHeight = 80;
  ...
  Widget _buildCourseColumn(
    ...
    for (var courses in courseList) {
      ...
      views.add(Positioned(
        top: fixedCourseCellHeight * (course.startNode - 1) + padding,
        height: fixedCourseCellHeight * course.nodeCount - padding,
        right: padding,
        left: padding,
    ...
    return SizedBox(
      height: fixedCourseCellHeight * counter,
      child: Stack(
        children: views,
      ),
    );
